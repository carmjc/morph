...
public class SelectionAdapter implements SelectionListener {
	...
	public void iwMenuItemDeselected(SelectionEvent selectionEvent) {
	}
	...
	public void shipDeselected(SelectionEvent selectionEvent) {
	}

	public void shipSelected(SelectionEvent selectionEvent) {
	}
