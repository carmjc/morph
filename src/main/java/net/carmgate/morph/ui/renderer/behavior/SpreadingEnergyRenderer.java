...
public class SpreadingEnergyRenderer extends BehaviorRenderer<SpreadingEnergy> {
	...
	@Override
	protected void renderBehavior(int glMode, RenderStyle drawType, SpreadingEnergy behavior) {
